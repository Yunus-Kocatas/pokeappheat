...
//
//     final mystat = mystatFromJson(jsonString);

import 'dart:convert';

Mystat mystatFromJson_stats(String str) => Mystat.fromJson(json.decode(str));

String mystatToJson(Mystat data) => json.encode(data.toJson());
...
class Mystat {
  ...
  factory Mystat.fromJson(Map<String, dynamic> json) => Mystat(
